      ...
      {calculatorVisible && (
       ...
       {showScoreOverlay && (
         <div className="fixed inset-0 bg-white flex items-center justify-center z-50 p-2 sm:p-4 md:p-8 overflow-y-auto">
           <div className="bg-white rounded-2xl sm:rounded-3xl max-w-sm sm:max-w-md md:max-w-lg lg:max-w-2xl w-full shadow-2xl overflow-y-auto border-2 border-blue-500 my-4 max-h-[90vh]">
