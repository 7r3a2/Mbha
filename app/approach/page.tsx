      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-2 sm:p-4 md:p-6 overflow-hidden min-w-0">
          {selectedContent && selectedContent.lecture ? (
            <div className={`${(selectedContent.lecture.id === 'card-5' || selectedContent.lecture.id === 'acute-pelvic-pain' || selectedContent.lecture.id === 'dyspareunia' || selectedContent.lecture.id === 'vulvar-vaginal-cancers' || selectedContent.lecture.id === 'vulvar-vaginal-infections-and-inflammation' || selectedContent.lecture.id === 'vulvar-dystrophies' || selectedContent.lecture.id === 'genital-ulcers' || selectedContent.lecture.id === 'abnormal-vaginal-discharge') && isFrameFullscreen ? 'fixed inset-0 z-50' : 'h-full w-full'} bg-white/95 backdrop-blur-sm border-2 border-blue-300 rounded-xl overflow-hidden shadow-xl`}>
